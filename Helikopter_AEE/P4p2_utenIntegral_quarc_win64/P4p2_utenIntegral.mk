...
MODEL                = P4p2_utenIntegral
MODULES              = P4p2_utenIntegral_data.c P4p2_utenIntegral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P4p2_utenIntegral.mk
...
MODELLIB                  = P4p2_utenIntegrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P4p2_utenIntegral_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P4p2_utenIntegral_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\part4
