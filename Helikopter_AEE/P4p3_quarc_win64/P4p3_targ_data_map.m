  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p3_B.RateTransition
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 38;
	
	  ;% P4p3_B.RateTransition1
	  section.data(20).logicalSrcIdx = 19;
  ...
  targMap.checksum0 = 4220186908;
  targMap.checksum1 = 3531489665;
  targMap.checksum2 = 3113698963;
  targMap.checksum3 = 587136316;
