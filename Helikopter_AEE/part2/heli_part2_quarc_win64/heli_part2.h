 ...
 */
#ifndef RTW_HEADER_heli_part2_h_
#define RTW_HEADER_heli_part2_h_
#include <string.h>
#ifndef heli_part2_COMMON_INCLUDES_
# define heli_part2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_part2_COMMON_INCLUDES_ */

#include "heli_part2_types.h"
...
#define heli_part2_rtModel             RT_MODEL_heli_part2_T
...
#define rtB                            heli_part2_B
#define BlockIO                        B_heli_part2_T
#define rtX                            heli_part2_X
#define ContinuousStates               X_heli_part2_T
#define rtXdot                         heli_part2_XDot
#define StateDerivatives               XDot_heli_part2_T
#define tXdis                          heli_part2_XDis
#define StateDisabled                  XDis_heli_part2_T
#define rtP                            heli_part2_P
#define Parameters                     P_heli_part2_T
#define rtDWork                        heli_part2_DW
#define D_Work                         DW_heli_part2_T

/* Parameters (auto storage) */
struct P_heli_part2_T_ {
...
extern P_heli_part2_T heli_part2_P;

/* Block signals (auto storage) */
extern B_heli_part2_T heli_part2_B;

/* Continuous states (auto storage) */
extern X_heli_part2_T heli_part2_X;

/* Block states (auto storage) */
extern DW_heli_part2_T heli_part2_DW;
...
extern void heli_part2_initialize(void);
extern void heli_part2_output0(void);
extern void heli_part2_update0(void);
extern void heli_part2_output(int_T tid);
extern void heli_part2_update(int_T tid);
extern void heli_part2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_part2_T *const heli_part2_M;
 ...
 *
 * '<Root>' : 'heli_part2'
 * '<S1>'   : 'heli_part2/Conversion'
 * '<S2>'   : 'heli_part2/Elevation controller'
 * '<S3>'   : 'heli_part2/Heli 3D'
 * '<S4>'   : 'heli_part2/Joystick'
 * '<S5>'   : 'heli_part2/Pitch controller'
 * '<S6>'   : 'heli_part2/Travel controller'
 * '<S7>'   : 'heli_part2/Elevation controller/Elevation controller'
 * '<S8>'   : 'heli_part2/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'heli_part2/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'heli_part2/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'heli_part2/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'heli_part2/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'heli_part2/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_part2_h_ */
