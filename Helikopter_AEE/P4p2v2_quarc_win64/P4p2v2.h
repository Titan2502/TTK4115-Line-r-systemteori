 ...
 */
#ifndef RTW_HEADER_P4p2v2_h_
#define RTW_HEADER_P4p2v2_h_
#include <string.h>
#ifndef P4p2v2_COMMON_INCLUDES_
# define P4p2v2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P4p2v2_COMMON_INCLUDES_ */

#include "P4p2v2_types.h"
...
#define P4p2v2_rtModel                 RT_MODEL_P4p2v2_T
...
typedef struct {
  ...
  real_T Gain_i;                       /* '<S7>/Gain' */
  real_T Gain_b;                       /* '<S8>/Gain' */
...
#define rtB                            P4p2v2_B
#define BlockIO                        B_P4p2v2_T
#define rtX                            P4p2v2_X
#define ContinuousStates               X_P4p2v2_T
#define rtXdot                         P4p2v2_XDot
#define StateDerivatives               XDot_P4p2v2_T
#define tXdis                          P4p2v2_XDis
#define StateDisabled                  XDis_P4p2v2_T
#define rtP                            P4p2v2_P
#define Parameters                     P_P4p2v2_T
#define rtDWork                        P4p2v2_DW
#define D_Work                         DW_P4p2v2_T
...
extern P_P4p2v2_T P4p2v2_P;

/* Block signals (auto storage) */
extern B_P4p2v2_T P4p2v2_B;

/* Continuous states (auto storage) */
extern X_P4p2v2_T P4p2v2_X;

/* Block states (auto storage) */
extern DW_P4p2v2_T P4p2v2_DW;
...
extern void P4p2v2_initialize(void);
extern void P4p2v2_output0(void);
extern void P4p2v2_update0(void);
extern void P4p2v2_output(int_T tid);
extern void P4p2v2_update(int_T tid);
extern void P4p2v2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P4p2v2_T *const P4p2v2_M;
 ...
 *
 * '<Root>' : 'P4p2v2'
 * '<S1>'   : 'P4p2v2/Conversion'
 * '<S2>'   : 'P4p2v2/Heli 3D'
 * '<S3>'   : 'P4p2v2/Joystick'
 * '<S4>'   : 'P4p2v2/LQR'
 * '<S5>'   : 'P4p2v2/Heli 3D/Elevation rad to deg'
 * '<S6>'   : 'P4p2v2/Heli 3D/Elevation rate rad to deg'
 * '<S7>'   : 'P4p2v2/Heli 3D/Pitch rad to deg'
 * '<S8>'   : 'P4p2v2/Heli 3D/Pitch rate rad to deg'
 * '<S9>'   : 'P4p2v2/Heli 3D/Travel rad to deg'
 * '<S10>'  : 'P4p2v2/Heli 3D/Travel rate  rad to deg'
 * '<S11>'  : 'P4p2v2/LQR/Subsystem'
 */
#endif                                 /* RTW_HEADER_P4p2v2_h_ */
