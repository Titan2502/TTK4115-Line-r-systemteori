...
MODEL                = P1p4
MODULES              = P1p4_data.c P1p4_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P1p4.mk
...
MODELLIB                  = P1p4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P1p4_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P1p4_quarc_win64
