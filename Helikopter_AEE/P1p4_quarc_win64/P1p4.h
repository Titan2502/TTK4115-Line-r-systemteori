 ...
 */
#ifndef RTW_HEADER_P1p4_h_
#define RTW_HEADER_P1p4_h_
#include <stddef.h>
#include <string.h>
#ifndef P1p4_COMMON_INCLUDES_
# define P1p4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P1p4_COMMON_INCLUDES_ */

#include "P1p4_types.h"
...
#define P1p4_rtModel                   RT_MODEL_P1p4_T
...
#define rtB                            P1p4_B
#define BlockIO                        B_P1p4_T
#define rtX                            P1p4_X
#define ContinuousStates               X_P1p4_T
#define rtXdot                         P1p4_XDot
#define StateDerivatives               XDot_P1p4_T
#define tXdis                          P1p4_XDis
#define StateDisabled                  XDis_P1p4_T
#define rtP                            P1p4_P
#define Parameters                     P_P1p4_T
#define rtDWork                        P1p4_DW
#define D_Work                         DW_P1p4_T
...
struct P_P1p4_T_ {
  ...
  real_T K_ed_Gain;                    /* Expression: 12
                                        ...
                                        */
  real_T e_ref1_Value;                 /* Expression: 0
                                        * Referenced by: '<Root>/e_ref1'
                                        */
...
extern P_P1p4_T P1p4_P;

/* Block signals (auto storage) */
extern B_P1p4_T P1p4_B;

/* Continuous states (auto storage) */
extern X_P1p4_T P1p4_X;

/* Block states (auto storage) */
extern DW_P1p4_T P1p4_DW;
...
extern void P1p4_initialize(void);
extern void P1p4_output0(void);
extern void P1p4_update0(void);
extern void P1p4_output(int_T tid);
extern void P1p4_update(int_T tid);
extern void P1p4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P1p4_T *const P1p4_M;
 ...
 * '<Root>' : 'P1p4'
 * '<S1>'   : 'P1p4/Conversion'
 * '<S2>'   : 'P1p4/Elevation controller'
 * '<S3>'   : 'P1p4/Heli 3D'
 * '<S4>'   : 'P1p4/Joystick'
 * '<S5>'   : 'P1p4/Pitch controller'
 * '<S6>'   : 'P1p4/Elevation controller/Elevation controller'
 * '<S7>'   : 'P1p4/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'P1p4/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'P1p4/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'P1p4/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'P1p4/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'P1p4/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P1p4_h_ */
