 ...
 * C source code generated on : Thu Oct 18 17:36:03 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitionx > P2p1_P.DeadZonex_End) {
      rtb_Deg_2_rad_idx_4 = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_End;
    } else if (P2p1_B.RateTransitionx >= P2p1_P.DeadZonex_Start) {
      rtb_Deg_2_rad_idx_4 = 0.0;
    } else {
      rtb_Deg_2_rad_idx_4 = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    P2p1_B.Joystick_gain_x = P2p1_P.Gainx_Gain * rtb_Deg_2_rad_idx_4 *
  ...
  /* Gain: '<Root>/Deg_2_rad' */
  rtb_Deg_2_rad_idx_4 = P2p1_P.Deg_2_rad_Gain * P2p1_B.Sum1;
  rtb_Deg_2_rad_idx_5 = P2p1_P.Deg_2_rad_Gain * P2p1_B.Gain_dg;
   ...
   *  Sum: '<S5>/Sum'
   */
  rtb_Frontgain = (P2p1_B.Joystick_gain_x - P2p1_P.Deg_2_rad_Gain * P2p1_B.Gain)
    * P2p1_P.K_pp - P2p1_P.Deg_2_rad_Gain * P2p1_B.Gain_b * P2p1_P.K_pd;
  ...
  /* Sum: '<S2>/Sum' */
  rtb_Sum_p = P2p1_B.e_ref - rtb_Deg_2_rad_idx_4;
  if (rtmIsMajorTimeStep(P2p1_M)) {
  ...
  rtb_Backgain = ((P2p1_P.K_ep_Gain * rtb_Sum_p + rtb_Backgain) -
                  P2p1_P.K_ed_Gain * rtb_Deg_2_rad_idx_5) + P2p1_B.Vs_const;
  ...
  /* Gain: '<S1>/Front gain' */
  rtb_Deg_2_rad_idx_4 *= P2p1_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_Deg_2_rad_idx_4 > P2p1_P.FrontmotorSaturation_UpperSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Deg_2_rad_idx_4 < P2p1_P.FrontmotorSaturation_LowerSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_LowerSat;
  } else {
    P2p1_B.FrontmotorSaturation = rtb_Deg_2_rad_idx_4;
  }
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    if (P2p1_B.RateTransitiony > P2p1_P.DeadZoney_End) {
      rtb_Deg_2_rad_idx_4 = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_End;
    } else if (P2p1_B.RateTransitiony >= P2p1_P.DeadZoney_Start) {
      rtb_Deg_2_rad_idx_4 = 0.0;
    } else {
      rtb_Deg_2_rad_idx_4 = P2p1_B.RateTransitiony - P2p1_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S4>/Gain: y'
     */
    P2p1_B.Joystick_gain_y = P2p1_P.Gainy_Gain * rtb_Deg_2_rad_idx_4 *
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (3161354329U);
  P2p1_M->Sizes.checksums[1] = (1311456756U);
  P2p1_M->Sizes.checksums[2] = (633931046U);
  P2p1_M->Sizes.checksums[3] = (2880231242U);
  ...
  P2p1_M->Sizes.numBlocks = (56);      /* Number of blocks */
  P2p1_M->Sizes.numBlockIO = (22);     /* Number of block outputs */
