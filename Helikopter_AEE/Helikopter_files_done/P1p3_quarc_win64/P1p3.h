 ...
 * C source code generated on : Thu Oct 18 17:24:13 2018
 *
 ...
 */
#ifndef RTW_HEADER_P1p3_h_
#define RTW_HEADER_P1p3_h_
#include <string.h>
#ifndef P1p3_COMMON_INCLUDES_
# define P1p3_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P1p3_COMMON_INCLUDES_ */

#include "P1p3_types.h"
...
#define P1p3_rtModel                   RT_MODEL_P1p3_T
...
#define rtB                            P1p3_B
#define BlockIO                        B_P1p3_T
#define rtX                            P1p3_X
#define ContinuousStates               X_P1p3_T
#define rtXdot                         P1p3_XDot
#define StateDerivatives               XDot_P1p3_T
#define tXdis                          P1p3_XDis
#define StateDisabled                  XDis_P1p3_T
#define rtP                            P1p3_P
#define Parameters                     P_P1p3_T
#define rtDWork                        P1p3_DW
#define D_Work                         DW_P1p3_T
...
extern P_P1p3_T P1p3_P;

/* Block signals (auto storage) */
extern B_P1p3_T P1p3_B;

/* Continuous states (auto storage) */
extern X_P1p3_T P1p3_X;

/* Block states (auto storage) */
extern DW_P1p3_T P1p3_DW;
...
extern void P1p3_initialize(void);
extern void P1p3_output0(void);
extern void P1p3_update0(void);
extern void P1p3_output(int_T tid);
extern void P1p3_update(int_T tid);
extern void P1p3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P1p3_T *const P1p3_M;
 ...
 * '<S2>'   : 'P1p3/Heli 3D'
 * '<S3>'   : 'P1p3/Joystick'
 * '<S4>'   : 'P1p3/Heli 3D/Elevation rad to deg'
 * '<S5>'   : 'P1p3/Heli 3D/Elevation rate rad to deg'
 * '<S6>'   : 'P1p3/Heli 3D/Pitch rad to deg'
 * '<S7>'   : 'P1p3/Heli 3D/Pitch rate rad to deg'
 * '<S8>'   : 'P1p3/Heli 3D/Travel rad to deg'
 * '<S9>'   : 'P1p3/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_P1p3_h_ */
