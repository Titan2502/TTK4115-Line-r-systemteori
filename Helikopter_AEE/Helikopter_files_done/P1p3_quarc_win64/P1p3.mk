...
MODEL                = P1p3
MODULES              = P1p3_data.c P1p3_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P1p3.mk
...
MODELLIB                  = P1p3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P1p3_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = E:\Helikopter_AEE\Helikopter_files_done
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P1p3_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\part1
