 ...
 * C source code generated on : Thu Oct 18 22:21:35 2018
 *
...
void P4p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  tmp_0[0] = P4p3_B.Integrator[0];
  tmp_0[1] = P4p3_B.Integrator[1];
  tmp_0[2] = P4p3_B.Integrator[3];
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Gain4[1] + rtb_Gain4[0]) * P4p3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Gain4[0] - rtb_Gain4[1]) * P4p3_P.Backgain_Gain;
  ...
  /* Sum: '<S12>/Sum2' */
  P4p3_B.Sum2_l = P4p3_B.Integrator[0] - P4p3_B.Joystick_gain_x;

  /* Sum: '<S12>/Sum' */
  P4p3_B.Sum = P4p3_B.Integrator[3] - P4p3_B.Joystick_gain_y;

  /* SignalConversion: '<S5>/TmpSignal ConversionAtGainInport1' incorporates:
   *  Gain: '<S5>/Gain'
   */
  tmp_1[0] = P4p3_B.Deg_2_rad[2];
  tmp_1[1] = P4p3_B.Deg_2_rad[3];
  tmp_1[2] = P4p3_B.Deg_2_rad[4];
  tmp_1[3] = P4p3_B.Deg_2_rad[5];
  tmp_1[4] = P4p3_B.Deg_2_rad[0];
  tmp_1[5] = P4p3_B.Deg_2_rad[1];
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Sum: '<S5>/Sum1'
     */
    tmp_4[i] = P4p3_P.B[i + 6] * rtb_Gain4[1] + P4p3_P.B[i] * rtb_Gain4[0];
  }
  ...
  for (i = 0; i < 6; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      u0 += P4p3_P.A[6 * i_0 + i] * P4p3_B.Integrator[i_0];
    }

    P4p3_B.Sum1_d[i] = (tmp_1[i] + tmp_4[i]) + u0;
  }
}
...
RT_MODEL_P4p3_T *P4p3(void)
{
  ...
  /* External mode info */
  P4p3_M->Sizes.checksums[0] = (3704052810U);
  P4p3_M->Sizes.checksums[1] = (3010714834U);
  P4p3_M->Sizes.checksums[2] = (3763240908U);
  P4p3_M->Sizes.checksums[3] = (457420886U);
  ...
  P4p3_M->Sizes.numBlocks = (60);      /* Number of blocks */
  P4p3_M->Sizes.numBlockIO = (24);     /* Number of block outputs */
  P4p3_M->Sizes.numBlockPrms = (228);  /* Sum of parameter "widths" */
  return P4p3_M;
}
