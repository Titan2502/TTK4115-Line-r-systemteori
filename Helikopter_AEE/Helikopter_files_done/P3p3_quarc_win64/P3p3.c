 ...
 * C source code generated on : Thu Oct 18 19:08:41 2018
 *
...
void P3p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Gain: '<S11>/R2D ' */
  P3p3_B.R2D[0] = P3p3_P.R2D_Gain * P3p3_B.Sum2;
  P3p3_B.R2D[1] = P3p3_P.R2D_Gain * P3p3_B.Sum;
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* ToFile: '<S11>/To File1' */
    if (rtmIsMajorTimeStep(P3p3_M)) {
      {
...
RT_MODEL_P3p3_T *P3p3(void)
{
  ...
  /* External mode info */
  P3p3_M->Sizes.checksums[0] = (254947883U);
  P3p3_M->Sizes.checksums[1] = (2802929024U);
  P3p3_M->Sizes.checksums[2] = (1218096543U);
  P3p3_M->Sizes.checksums[3] = (1288045695U);
  ...
  P3p3_M->Sizes.numBlocks = (49);      /* Number of blocks */
