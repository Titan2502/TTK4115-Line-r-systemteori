 ...
 * C source code generated on : Fri Aug 31 15:38:52 2018
 *
...
void P3p2_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  P3p2_B.Gain_d = (P3p2_P.TravelTransferFcn_C * P3p2_X.TravelTransferFcn_CSTATE
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    ...
    /* Gain: '<S7>/Gain' */
    P3p2_B.Gain_i = P3p2_P.Gain_Gain_a * P3p2_B.PitchCounttorad;
  }
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
     ...
     */
    P3p2_B.Sum1 = P3p2_B.Gain_e + P3p2_P.offset_e_Value;
  }

  /* Gain: '<S6>/Gain' incorporates:
   *  TransferFcn: '<S2>/Elevation: Transfer Fcn'
   */
  P3p2_B.Gain_dg = (P3p2_P.ElevationTransferFcn_C *
  ...
  rtb_Deg_2_rad_idx_3 = P3p2_P.Deg_2_rad_Gain * P3p2_B.Gain_b;
  rtb_Deg_2_rad_idx_5 = P3p2_P.Deg_2_rad_Gain * P3p2_B.Gain_dg;
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_Sum[i] = P3p2_B.P[i] - ((P3p2_P.K[i + 2] * rtb_Deg_2_rad_idx_3 +
      P3p2_P.K[i] * rtb_Deg_2_rad_idx_2) + P3p2_P.K[i + 4] * rtb_Deg_2_rad_idx_5);
  }
