...
MODEL                = P4p3_utenIntegral
MODULES              = P4p3_utenIntegral_data.c P4p3_utenIntegral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = P4p3_utenIntegral.mk
...
MODELLIB                  = P4p3_utenIntegrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = P4p3_utenIntegral_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\P4p3_utenIntegral_quarc_win64
