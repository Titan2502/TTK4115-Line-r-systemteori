 ...
 */
#ifndef RTW_HEADER_P4p3_utenIntegral_h_
#define RTW_HEADER_P4p3_utenIntegral_h_
#include <string.h>
#ifndef P4p3_utenIntegral_COMMON_INCLUDES_
# define P4p3_utenIntegral_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* P4p3_utenIntegral_COMMON_INCLUDES_ */

#include "P4p3_utenIntegral_types.h"
...
#define P4p3_utenIntegral_rtModel      RT_MODEL_P4p3_utenIntegral_T
...
#define rtB                            P4p3_utenIntegral_B
#define BlockIO                        B_P4p3_utenIntegral_T
#define rtX                            P4p3_utenIntegral_X
#define ContinuousStates               X_P4p3_utenIntegral_T
#define rtXdot                         P4p3_utenIntegral_XDot
#define StateDerivatives               XDot_P4p3_utenIntegral_T
#define tXdis                          P4p3_utenIntegral_XDis
#define StateDisabled                  XDis_P4p3_utenIntegral_T
#define rtP                            P4p3_utenIntegral_P
#define Parameters                     P_P4p3_utenIntegral_T
#define rtDWork                        P4p3_utenIntegral_DW
#define D_Work                         DW_P4p3_utenIntegral_T

/* Parameters (auto storage) */
struct P_P4p3_utenIntegral_T_ {
...
struct tag_RTM_P4p3_utenIntegral_T {
  const char_T *path;
...
extern P_P4p3_utenIntegral_T P4p3_utenIntegral_P;

/* Block signals (auto storage) */
extern B_P4p3_utenIntegral_T P4p3_utenIntegral_B;

/* Continuous states (auto storage) */
extern X_P4p3_utenIntegral_T P4p3_utenIntegral_X;

/* Block states (auto storage) */
extern DW_P4p3_utenIntegral_T P4p3_utenIntegral_DW;
...
extern void P4p3_utenIntegral_initialize(void);
extern void P4p3_utenIntegral_output0(void);
extern void P4p3_utenIntegral_update0(void);
extern void P4p3_utenIntegral_output(int_T tid);
extern void P4p3_utenIntegral_update(int_T tid);
extern void P4p3_utenIntegral_terminate(void);

/* Real-time Model object */
extern RT_MODEL_P4p3_utenIntegral_T *const P4p3_utenIntegral_M;
 ...
 *
 * '<Root>' : 'P4p3_utenIntegral'
 * '<S1>'   : 'P4p3_utenIntegral/Conversion'
 * '<S2>'   : 'P4p3_utenIntegral/Heli 3D'
 * '<S3>'   : 'P4p3_utenIntegral/Joystick'
 * '<S4>'   : 'P4p3_utenIntegral/LQR'
 * '<S5>'   : 'P4p3_utenIntegral/State Estimator'
 * '<S6>'   : 'P4p3_utenIntegral/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'P4p3_utenIntegral/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'P4p3_utenIntegral/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'P4p3_utenIntegral/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'P4p3_utenIntegral/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'P4p3_utenIntegral/Heli 3D/Travel rate  rad to deg'
 * '<S12>'  : 'P4p3_utenIntegral/State Estimator/ p,e,l --> l,p,e'
 * '<S13>'  : 'P4p3_utenIntegral/State Estimator/l,p,e --> p,e,l'
 */
#endif                                 /* RTW_HEADER_P4p3_utenIntegral_h_ */
