  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P4p2_integral_P.Deg_2_rad_Gain
	  ...
	  ;% P4p2_integral_P.R2D_Gain
	  section.data(32).logicalSrcIdx = 106;
	  section.data(32).dtTransOffset = 31;
	
	  ;% P4p2_integral_P.R2D1_Gain
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p2_integral_B.RateTransition2
	  section.data(17).logicalSrcIdx = 16;
	  ...
	  ;% P4p2_integral_B.Gain_bg
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 39;
	
	  ;% P4p2_integral_B.RateTransition
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 40;
	
	  ;% P4p2_integral_B.RateTransition1
	  section.data(22).logicalSrcIdx = 21;
  ...
  targMap.checksum0 = 157773278;
  targMap.checksum1 = 299995677;
  targMap.checksum2 = 3349189379;
  targMap.checksum3 = 2331685149;
