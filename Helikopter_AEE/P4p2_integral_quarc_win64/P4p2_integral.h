...
typedef struct {
  ...
  real_T Integrator_CSTATE_i;          /* '<S12>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_i;       /* '<S12>/Integrator' */
 ...
 * '<S3>'   : 'P4p2_integral/Joystick'
 * '<S4>'   : 'P4p2_integral/LQR'
 * '<S5>'   : 'P4p2_integral/State Estimator'
 ...
 * '<S12>'  : 'P4p2_integral/LQR/Subsystem'
 * '<S13>'  : 'P4p2_integral/State Estimator/ p,e,l --> l,p,e'
 * '<S14>'  : 'P4p2_integral/State Estimator/l,p,e --> p,e,l'
 */
