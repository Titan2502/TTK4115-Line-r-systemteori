 ...
 * C source code generated on : Wed Oct 17 19:58:22 2018
 *
  ...
  *rtmPerTaskSampleHits )
{
  ...
  rtmSampleHitPtr[3] = rtmStepTask(P4p2_integral_M, 3);
...
static void rate_monotonic_scheduler(void)
{
  ...
  P4p2_integral_M->Timing.RateInteraction.TID0_2 =
    (P4p2_integral_M->Timing.TaskCounters.TID[2] == 0);

  /* update PerTaskSampleHits matrix for non-inline sfcn */
  P4p2_integral_M->Timing.perTaskSampleHits[2] =
    P4p2_integral_M->Timing.RateInteraction.TID0_2;
  ...
  if (P4p2_integral_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    /* update PerTaskSampleHits matrix for non-inline sfcn */
    P4p2_integral_M->Timing.perTaskSampleHits[6] =
      P4p2_integral_M->Timing.RateInteraction.TID1_2;
    P4p2_integral_M->Timing.RateInteraction.TID1_3 =
      (P4p2_integral_M->Timing.TaskCounters.TID[3] == 0);

    /* update PerTaskSampleHits matrix for non-inline sfcn */
    P4p2_integral_M->Timing.perTaskSampleHits[7] =
      P4p2_integral_M->Timing.RateInteraction.TID1_3;
  }
  ...
  if ((P4p2_integral_M->Timing.TaskCounters.TID[2]) > 2) {/* Sample time: [0.006s, 0.0s] */
    P4p2_integral_M->Timing.TaskCounters.TID[2] = 0;
  }

  (P4p2_integral_M->Timing.TaskCounters.TID[3])++;
  if ((P4p2_integral_M->Timing.TaskCounters.TID[3]) > 4) {/* Sample time: [0.01s, 0.0s] */
    P4p2_integral_M->Timing.TaskCounters.TID[3] = 0;
  }
}
...
void P4p2_integral_output0(void)       /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    if (P4p2_integral_M->Timing.RateInteraction.TID1_3) {
    ...
    if (P4p2_integral_B.RateTransitionx > P4p2_integral_P.DeadZonex_End) {
      u0 = P4p2_integral_B.RateTransitionx - P4p2_integral_P.DeadZonex_End;
    } else if (P4p2_integral_B.RateTransitionx >=
               P4p2_integral_P.DeadZonex_Start) {
      u0 = 0.0;
    } else {
      u0 = P4p2_integral_B.RateTransitionx - P4p2_integral_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S3>/Gain: x'
     */
    P4p2_integral_B.Joystick_gain_x = P4p2_integral_P.Gainx_Gain * u0 *
      P4p2_integral_P.Joystick_gain_x;

    /* Gain: '<Root>/Gain1' */
    P4p2_integral_B.Gain1 = P4p2_integral_P.Gain1_Gain *
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M) &&
      P4p2_integral_M->Timing.RateInteraction.TID0_2) {
    P4p2_integral_B.RateTransition2[0] = P4p2_integral_B.Gain;
    P4p2_integral_B.RateTransition2[1] = P4p2_integral_B.Gain_d;
    P4p2_integral_B.RateTransition2[2] = P4p2_integral_B.Gain_i;
    P4p2_integral_B.RateTransition2[3] = P4p2_integral_B.Gain_b;
    P4p2_integral_B.RateTransition2[4] = P4p2_integral_B.Sum1;
    P4p2_integral_B.RateTransition2[5] = P4p2_integral_B.Gain_dg;
  }
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    if (P4p2_integral_B.RateTransitiony > P4p2_integral_P.DeadZoney_End) {
      u0 = P4p2_integral_B.RateTransitiony - P4p2_integral_P.DeadZoney_End;
    } else if (P4p2_integral_B.RateTransitiony >=
               P4p2_integral_P.DeadZoney_Start) {
      u0 = 0.0;
    } else {
      u0 = P4p2_integral_B.RateTransitiony - P4p2_integral_P.DeadZoney_Start;
    }
     ...
     *  Gain: '<S3>/Gain: y'
     */
    P4p2_integral_B.Joystick_gain_y = P4p2_integral_P.Gainy_Gain * u0 *
      P4p2_integral_P.Joystick_gain_y;

    /* Gain: '<Root>/Gain' */
    P4p2_integral_B.Gain_bg = P4p2_integral_P.Gain_Gain_c *
      P4p2_integral_B.Joystick_gain_y;

    /* Gain: '<Root>/R2D ' */
    rtb_R2D[0] = P4p2_integral_P.R2D_Gain * P4p2_integral_B.Gain1;
    rtb_R2D[1] = P4p2_integral_P.R2D_Gain * P4p2_integral_B.Gain_bg;

    /* RateTransition: '<Root>/Rate Transition' */
    if (P4p2_integral_M->Timing.RateInteraction.TID1_2) {
      P4p2_integral_B.RateTransition[0] = rtb_R2D[0];
      P4p2_integral_B.RateTransition[1] = rtb_R2D[1];
    }
  ...
  /* Gain: '<Root>/R2D 1' */
  rtb_Gain1[0] = P4p2_integral_P.R2D1_Gain * P4p2_integral_B.Integrator[4];
  rtb_Gain1[1] = P4p2_integral_P.R2D1_Gain * P4p2_integral_B.Integrator[5];
  rtb_Gain1[2] = P4p2_integral_P.R2D1_Gain * P4p2_integral_B.Integrator[0];
  rtb_Gain1[3] = P4p2_integral_P.R2D1_Gain * P4p2_integral_B.Integrator[1];
  rtb_Gain1[4] = P4p2_integral_P.R2D1_Gain * P4p2_integral_B.Integrator[2];
  rtb_Gain1[5] = P4p2_integral_P.R2D1_Gain * P4p2_integral_B.Integrator[3];

  /* RateTransition: '<Root>/Rate Transition1' */
  if (rtmIsMajorTimeStep(P4p2_integral_M) &&
      P4p2_integral_M->Timing.RateInteraction.TID0_2) {
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.RateTransition1[i] = rtb_Gain1[i];
    }
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_R2D[1] + rtb_R2D[0]) * P4p2_integral_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_R2D[0] - rtb_R2D[1]) * P4p2_integral_P.Backgain_Gain;
  ...
  /* Sum: '<S12>/Sum2' */
  P4p2_integral_B.Sum2_l = P4p2_integral_B.Integrator[0] - P4p2_integral_B.Gain1;

  /* Sum: '<S12>/Sum' */
  P4p2_integral_B.Sum = P4p2_integral_B.Integrator[3] - P4p2_integral_B.Gain_bg;

  /* SignalConversion: '<S5>/TmpSignal ConversionAtGainInport1' */
  rtb_Gain1[0] = P4p2_integral_B.Deg_2_rad[2];
  rtb_Gain1[1] = P4p2_integral_B.Deg_2_rad[3];
  rtb_Gain1[2] = P4p2_integral_B.Deg_2_rad[4];
  rtb_Gain1[3] = P4p2_integral_B.Deg_2_rad[5];
  rtb_Gain1[4] = P4p2_integral_B.Deg_2_rad[0];
  rtb_Gain1[5] = P4p2_integral_B.Deg_2_rad[1];

  /* Gain: '<S5>/Gain' */
  for (i = 0; i < 3; i++) {
    rtb_Sum[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      rtb_Sum[i] += P4p2_integral_P.C[3 * i_0 + i] * rtb_Gain1[i_0];
    }
  }
  ...
  /* Gain: '<S5>/Gain1' */
  for (i = 0; i < 6; i++) {
    rtb_Gain1[i] = P4p2_integral_P.B[i + 6] * rtb_R2D[1] + P4p2_integral_P.B[i] *
      rtb_R2D[0];
  }
  ...
  for (i = 0; i < 3; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      u0 += P4p2_integral_P.C[3 * i_0 + i] * P4p2_integral_B.Integrator[i_0];
    }
  ...
  for (i = 0; i < 6; i++) {
     ...
     *  Gain: '<S5>/Gain3'
     */
    tmp_1[i] = ((P4p2_integral_P.L[i + 6] * rtb_Sum[1] + P4p2_integral_P.L[i] *
                 rtb_Sum[0]) + P4p2_integral_P.L[i + 12] * rtb_Sum[2]) +
      rtb_Gain1[i];
    ...
    tmp_2[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_2[i] += P4p2_integral_P.A[6 * i_0 + i] *
    ...
    /* Sum: '<S5>/Sum1' */
    P4p2_integral_B.Sum1_d[i] = tmp_1[i] + tmp_2[i];
  }
...
void P4p2_integral_output2(void)       /* Sample time: [0.006s, 0.0s] */
{
  /* ToFile: '<Root>/To File' */
  {
    if (!(++P4p2_integral_DW.ToFile_IWORK.Decimation % 1) &&
      ...
      if (fp != (NULL)) {
        ...
        u[0] = P4p2_integral_M->Timing.t[2];
        u[1] = P4p2_integral_B.RateTransition2[0];
        u[2] = P4p2_integral_B.RateTransition2[1];
        u[3] = P4p2_integral_B.RateTransition2[2];
        u[4] = P4p2_integral_B.RateTransition2[3];
        u[5] = P4p2_integral_B.RateTransition2[4];
        u[6] = P4p2_integral_B.RateTransition2[5];
        if (fwrite(u, sizeof(real_T), 7, fp) != 7) {
          rtmSetErrorStatus(P4p2_integral_M,
                            "Error writing to MAT-file p4p2_states_V6.mat");
          return;
        }
        ...
        if (((++P4p2_integral_DW.ToFile_IWORK.Count)*7)+1 >= 100000000) {
          (void)fprintf(stdout,
                        ...
                        "    allowed in MAT-file p4p2_states_V6.mat.\n");
        }
      }
    }
  }
  ...
  /* ToFile: '<Root>/To File1' */
  {
    if (!(++P4p2_integral_DW.ToFile1_IWORK.Decimation % 1) &&
      ...
      if (fp != (NULL)) {
        ...
        u[0] = P4p2_integral_M->Timing.t[2];
        u[1] = P4p2_integral_B.RateTransition[0];
        u[2] = P4p2_integral_B.RateTransition[1];
        if (fwrite(u, sizeof(real_T), 3, fp) != 3) {
          rtmSetErrorStatus(P4p2_integral_M,
                            "Error writing to MAT-file p4p2_reference_V6.mat");
          return;
        }
        ...
        if (((++P4p2_integral_DW.ToFile1_IWORK.Count)*3)+1 >= 100000000) {
          (void)fprintf(stdout,
                        ...
                        "    the simulation has ended, because it has reached\n"
                        "    the maximum number of elements (100000000)\n"
                        "    allowed in MAT-file p4p2_reference_V6.mat.\n");
        }
      }
    }
  }
  ...
  /* ToFile: '<Root>/To File2' */
  {
    if (!(++P4p2_integral_DW.ToFile2_IWORK.Decimation % 1) &&
        (P4p2_integral_DW.ToFile2_IWORK.Count*7)+1 < 100000000 ) {
      FILE *fp = (FILE *) P4p2_integral_DW.ToFile2_PWORK.FilePtr;
      if (fp != (NULL)) {
        real_T u[7];
        P4p2_integral_DW.ToFile2_IWORK.Decimation = 0;
        u[0] = P4p2_integral_M->Timing.t[2];
        u[1] = P4p2_integral_B.RateTransition1[0];
        u[2] = P4p2_integral_B.RateTransition1[1];
        u[3] = P4p2_integral_B.RateTransition1[2];
        u[4] = P4p2_integral_B.RateTransition1[3];
        u[5] = P4p2_integral_B.RateTransition1[4];
        u[6] = P4p2_integral_B.RateTransition1[5];
        if (fwrite(u, sizeof(real_T), 7, fp) != 7) {
          rtmSetErrorStatus(P4p2_integral_M,
                            "Error writing to MAT-file p4p2_estimate_V6.mat");
          return;
        }

        if (((++P4p2_integral_DW.ToFile2_IWORK.Count)*7)+1 >= 100000000) {
          (void)fprintf(stdout,
                        "*** The ToFile block will stop logging data before\n"
                        "    the simulation has ended, because it has reached\n"
                        "    the maximum number of elements (100000000)\n"
                        "    allowed in MAT-file p4p2_estimate_V6.mat.\n");
        }
      }
    }
  }
...
void P4p2_integral_update2(void)       /* Sample time: [0.006s, 0.0s] */
{
  /* Update absolute time */
...
void P4p2_integral_output3(void)       /* Sample time: [0.01s, 0.0s] */
{
...
void P4p2_integral_update3(void)       /* Sample time: [0.01s, 0.0s] */
{
   ...
   */
  if (!(++P4p2_integral_M->Timing.clockTick3)) {
    ++P4p2_integral_M->Timing.clockTickH3;
  }

  P4p2_integral_M->Timing.t[3] = P4p2_integral_M->Timing.clockTick3 *
    P4p2_integral_M->Timing.stepSize3 + P4p2_integral_M->Timing.clockTickH3 *
    P4p2_integral_M->Timing.stepSize3 * 4294967296.0;
}
...
void P4p2_integral_initialize(void)
{
  ...
  {
    char fileName[509] = "p4p2_states_V6.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file p4p2_states_V6.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,7,0,"states")) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error writing mat file header to file p4p2_states_V6.mat");
      return;
    }
  ...
  {
    char fileName[509] = "p4p2_reference_V6.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file p4p2_reference_V6.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,3,0,"reference")) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error writing mat file header to file p4p2_reference_V6.mat");
      return;
    }
  ...
  {
    char fileName[509] = "p4p2_estimate_V6.mat";
    FILE *fp = (NULL);
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error creating .mat file p4p2_estimate_V6.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,7,0,"estimate")) {
      rtmSetErrorStatus(P4p2_integral_M,
                        "Error writing mat file header to file p4p2_estimate_V6.mat");
      return;
    }
...
void P4p2_integral_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file p4p2_states_V6.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file p4p2_states_V6.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 7, P4p2_integral_DW.ToFile_IWORK.Count,
           "states")) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error writing header for states to MAT-file p4p2_states_V6.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File1' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file p4p2_reference_V6.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file p4p2_reference_V6.mat");
        return;
      }
      ...
      if (rt_WriteMat4FileHeader(fp, 3, P4p2_integral_DW.ToFile1_IWORK.Count,
           "reference")) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error writing header for reference to MAT-file p4p2_reference_V6.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File2' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error closing MAT-file p4p2_estimate_V6.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error reopening MAT-file p4p2_estimate_V6.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 7, P4p2_integral_DW.ToFile2_IWORK.Count,
           "estimate")) {
        rtmSetErrorStatus(P4p2_integral_M,
                          "Error writing header for estimate to MAT-file p4p2_estimate_V6.mat");
      }
...
RT_MODEL_P4p2_integral_T *P4p2_integral(void)
{
  ...
  /* Initialize timing info */
  {
    ...
    P4p2_integral_M->Timing.sampleTimes[2] = (0.006);
    P4p2_integral_M->Timing.sampleTimes[3] = (0.01);

    /* task offsets */
    P4p2_integral_M->Timing.offsetTimes[0] = (0.0);
    P4p2_integral_M->Timing.offsetTimes[1] = (0.0);
    P4p2_integral_M->Timing.offsetTimes[2] = (0.0);
    P4p2_integral_M->Timing.offsetTimes[3] = (0.0);
  }
  ...
  P4p2_integral_M->Timing.stepSize2 = 0.006;
  P4p2_integral_M->Timing.stepSize3 = 0.01;

  /* External mode info */
  P4p2_integral_M->Sizes.checksums[0] = (157773278U);
  P4p2_integral_M->Sizes.checksums[1] = (299995677U);
  P4p2_integral_M->Sizes.checksums[2] = (3349189379U);
  P4p2_integral_M->Sizes.checksums[3] = (2331685149U);
...

  {
    ...
    for (i = 0; i < 6; i++) {
      P4p2_integral_B.RateTransition2[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      P4p2_integral_B.RateTransition1[i] = 0.0;
    }
    ...
    P4p2_integral_B.Gain_bg = 0.0;
    P4p2_integral_B.RateTransition[0] = 0.0;
    P4p2_integral_B.RateTransition[1] = 0.0;
  ...
  P4p2_integral_M->Sizes.numSampTimes = (4);/* Number of sample times */
  P4p2_integral_M->Sizes.numBlocks = (71);/* Number of blocks */
  P4p2_integral_M->Sizes.numBlockIO = (29);/* Number of block outputs */
  P4p2_integral_M->Sizes.numBlockPrms = (244);/* Sum of parameter "widths" */
